...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeRNLlamaSpecJSI_getFormattedChat(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "getFormattedChat", @selector(getFormattedChat:messages:chatTemplate:resolve:reject:), args, count);
    }
  ...
  NativeRNLlamaSpecJSI::NativeRNLlamaSpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["getFormattedChat"] = MethodMetadata {3, __hostFunction_NativeRNLlamaSpecJSI_getFormattedChat};
